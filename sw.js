...
const CACHE_NAME = 'V3.4.131  更新日期：20260629';

// 更新日志（每次发布新版本时更新）
const UPDATE_LOGS = [
    'feat 添加客户门户功能，生成可分享链接让客户在线查看报价',
    'feat 添加电子签名功能，客户可在公开页面手写签名确认报价',
    'feat 添加签名确认码，客户签署后生成6位确认码供商家验证',
    'feat 添加已签署确认链接，包含签名数据便于商家导入',
    'feat 添加导入签署链接功能，商家可将客户签名应用到报价单',
    'feat 客户签名支持拖拽调整位置，位置自动保存',
    'bug 修复大写金额转换错误（拾百柒千叁万柒 → 玖仟柒佰叁拾柒元整）',
    'bug 修复不同报价单共享签名状态的问题',
    'bug 修复客户签名无法拖拽调整位置的问题',
