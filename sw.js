...
const CACHE_NAME = 'V3.4.135  更新日期：20260707';

// 更新日志（每次发布新版本时更新）
const UPDATE_LOGS = [
    'feat 登录界面"3天内自动登录"改为"7天内自动登录"',
    'bug 修复未勾选自动登录时页面刷新立即失效的问题，改为1天有效期',
    'feat 添加退出登录功能，用户可主动退出登录状态',
    'feat 密码修改后自动使现有会话失效，提高安全性',
    'feat 移动端适配优化：供应商报价表单、管理弹窗、产品详情弹窗均已适配手机端',
